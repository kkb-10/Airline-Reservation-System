...
public class AdminLoginPage extends JFrame {
	...
	public AdminLoginPage() {
		...
		lblNewLabel.setBounds(736, 338, 75, 13);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if(server.adminValidation(userId, password)==false)
				{
		...
		JLabel lblNewLabel_10 = new JLabel("ADMIN LOGIN");
		lblNewLabel_10.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 18));
		lblNewLabel_10.setBounds(349, 540, 297, 38);
		...
		JPanel panel = new JPanel()
		{
			public void paintComponent(Graphics g) {  
                Image img = Toolkit.getDefaultToolkit().getImage(  
                          AdminLoginPage.class.getResource("/images/SignUpicon1.jpg"));  
